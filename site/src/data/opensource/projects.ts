...
export const projects: ProjectItem[] = [
  {
    header: {
      key: 'Issue',
      value: 'Lack of user-friendly tools for managing Wi-Fi on headless Linux devices (e.g. Raspberry Pi)'
    },
  ...
  },
  {
    header: {
      key: 'Issue',
      value: 'Complex workflows for publishing articles and content simultaneously to multiple platforms'
    },
